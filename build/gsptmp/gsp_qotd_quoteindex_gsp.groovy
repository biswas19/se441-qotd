...
class gsp_qotd_quoteindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/quote/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(quoteList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(quoteCount ?: 0)],-1)
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1459478606043L
